...
import { vulnerabilityDescription, vulnerabilityImpact, stepsToReproduce, mitigationSteps } from "../data/mock-data"
  ...
  return (
    <div className="p-6">
      <div className="flex items-center mb-6">
        <Button variant="ghost" className="text-white mr-2" onClick={onBackClick}>
      ...
      <div className="flex justify-between items-start mb-6">
        <h1 className="text-2xl font-bold flex-1 pr-4">Local File Inclusion (LFI) on Home Page - {report.url}</h1>
        <Button variant="ghost" className="text-white" onClick={onToggleBookmark}>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-zinc-900 rounded-md p-2 border border-zinc-800">
            <img src="/code-analysis-flowchart.png" alt="PoC Screenshot 1" className="w-full h-auto rounded" />
          </div>
          <div className="bg-zinc-900 rounded-md p-2 border border-zinc-800">
            <img src="/abstract-code-compilation.png" alt="PoC Screenshot 2" className="w-full h-auto rounded" />
          </div>
          <div className="bg-zinc-900 rounded-md p-2 border border-zinc-800">
            <img src="/code-snippet-display.png" alt="PoC Screenshot 3" className="w-full h-auto rounded" />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-4">
        <Button className="bg-blue-600 hover:bg-blue-700 text-white" onClick={onApprovePayoutClick}>
          Approve Payout
        </Button>
        <Button variant="outline" className="border-zinc-700 text-white hover:bg-zinc-800" onClick={onViewProjectClick}>
          View Project
        </Button>
        <Button
          variant="outline"
