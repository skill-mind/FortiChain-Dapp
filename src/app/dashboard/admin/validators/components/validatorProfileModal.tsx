    ...
    <div className="fixed inset-0 backdrop-blur-md bg-[#504F4F0F] bg-opacity-70 flex items-center justify-center z-50 p-4">
      <div className="bg-[#1C1618] rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto relative">
        ...
        <div className="p-6 flex justify-end gap-4"> 
          <button
            onClick={onReject}
            className="px-6 py-2 bg-neutral-700 hover:bg-neutral-600 text-white font-medium rounded-md"
          >
            Reject Profile
          </button>
          <button
            onClick={onApprove}
            className="px-6 py-2 bg-[#0000FF] hover:bg-blue-700 text-white font-medium rounded-md"
          >
            Approve Profile
          </button>
        </div>
