...
interface SuspensionSuccessModalProps {
  isOpen: boolean;
  onClose: () => void;
  validatorId: string;
}

const SuspensionSuccessModal: React.FC<SuspensionSuccessModalProps> = ({
  isOpen,
  onClose,
  validatorId,
}) => {
    ...
    <div className="fixed inset-0 backdrop-blur-md bg-[#504F4F0F] bg-opacity-70 flex items-center justify-center z-50">
      <div className="bg-[#211A1D] border border-[#464043] rounded-lg w-full max-w-md p-6 text-center">
        ...
        <p className="text-neutral-400 text-sm mb-8">
          User {validatorId} has been successfully suspended.
        </p>
...
export default SuspensionSuccessModal;
