    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="bg-[#161113] border border-neutral-800 rounded-lg p-6 w-full max-w-2xl sm:max-w-3xl md:max-w-4xl lg:max-w-5xl h-[90vh] overflow-y-auto">
        ...
        <motion.div 
          ...
          animate="visible"
        >
          <motion.p className="text-gray-300 text-sm sm:text-base mb-2" variants={itemVariants}>2 attachments</motion.p>
        ...
        <h3 className="text-gray-300 text-sm sm:text-base font-semibold mb-4">Your Reply</h3>
