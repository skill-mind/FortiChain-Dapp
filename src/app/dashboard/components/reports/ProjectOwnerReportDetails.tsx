...
import { reports, ReportData } from "../type/ReportData";
...
import {
  ...
  buttonVariants,
  modalItemVariants,
} from "../type/projectowneranimations";
...
const ProjectOwnerReportDetails: React.FC<Props> = ({ vulnerabilityIndex, setCurrentView }) => {
...
export default ProjectOwnerReportDetails;
