...
export default function WriteAReportWriteAReport({
  isOpen,
  onClose,
  projectId,
}: WriteAReportProps) {
  ...
  return (
    <div className="min-h-screen bg-[#110D0F] text-white p-10 bg-[#504F4F0F] top-0 inset-0 backdrop-blur-lg z-50 w-full fixed overflow-y-auto">
      <motion.div
        initial={{ y: 100, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ type: "spring", stiffness: 80 }}
        className="flex flex-col w-full rounded-[20px] bg-[#1C1618] border px-6 py-8 border-[#464043] relative max-w-6xl mx-auto"
      >
  ...
  Fortichain Security Vulnerability Report
        ...
        <div className="mb-8">
          ...
          <div className="border border-dashed border-[#464043] rounded-lg p-6 flex flex-col items-center justify-center">
            ...
            <p className="text-xs text-gray-500 mt-2">Supports PDF, DOC, DOCX up to 10MB</p>
          </div>
        </div>
        ...
        <div className="flex justify-end">
          <button
            ...
            className="bg-gradient-to-r from-[#0000FF] to-[#0044FF] text-white text-[16px] font-[500] py-3 px-6 rounded-full hover:opacity-90 transition"
          >
            Submit Report
          </button>
        </div>
