...
const SubSection: React.FC<SubSectionProps> = ({ title, content }) => (
  <div>
    ...
    <p className="font-normal text-base leading-[150%]">{content}</p>
  </div>
);
...
const PrivacyPolicy = () => {
  ...
  return (
    <div className='bg-[url("/Hero.svg")] bg-no-repeat'>
      ...
      <Navbar />
      <div className="py-10">
        <h1 className="font-semibold text-[64px] leading-none tracking-normal text-center pb-10 pt-24">
          Privacy Policy
        </h1>
        <p className="font-light text-base leading-none tracking-normal text-center max-w-[593px] m-auto mb-12">
          FortiChain prioritizes user privacy and data security. The following
          policies outline our commitments and practices:
        </p>
        <div className="bg-[#211A1D] rounded-[40px] p-10 border border-gray-500 max-w-[969px] m-auto">
          <ol className="flex flex-col gap-5 list-decimal bold-numbers">
