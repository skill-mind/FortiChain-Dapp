...
//                   className={`
//                     cursor-pointer hover:text-gray-300
//                     ${isActive("/how-it-works") ? "text-blue-500 font-semibold" : ""}
//                   `}
//                 >
//                   How It Works
//                 </span>
...
//               <span
//                 className={`
//                   block cursor-pointer rounded-md px-3 py-2 text-base font-medium hover:bg-gray-700 hover:text-white
...
//                 className={`
//                   block cursor-pointer rounded-md px-3 py-2 text-base font-medium hover:bg-gray-700 hover:text-white
//                   ${isActive("/how-it-works") ? "bg-gray-700 text-blue-400" : ""}
//                 `}
//               >
//                 How It Works
//               </span>
...
//                 className={`
//                   block cursor-pointer rounded-md px-3 py-2 text-base font-medium hover:bg-gray-700 hover:text-white
//                   ${isActive("/about") ? "bg-gray-700 text-blue-400" : ""}
//                 `}
//               >
//                 About
//               </span>
